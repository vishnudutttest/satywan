...
const AddBrrower = ()=>{
    ...
    const [formdata,Setformdata] = useState({name1:"test",email:'email@yahoo.com',phone:9898989898,address:'asdfsadf',AmountGiven:4000,no_of_installment:20,intallmentType:1,installmentAmount:300,installmentStartDate:'2022-11-22'});
